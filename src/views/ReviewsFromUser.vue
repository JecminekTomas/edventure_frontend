                ...
                <v-card class="pb-4"
                  ...
                  <v-container>
                    <v-row justify="start" justify-md="space-between">
                      <v-col cols="12">
                        <v-card-title>
                          {{ `pro ${review['userTo']['lastName']} ${review['userTo']['firstName']}` }}
                        </v-card-title>
        ...
        <v-container v-else>
          <v-row>
            <v-col cols="12" class="text-center">
              <img src="../assets/states/no_data_2.svg" width="50%" alt="No review" class="mb-5">
              <div class="text-h6">Dosud jste nikoho neohodnotil.</div>
            </v-col>
          </v-row>
        </v-container>
      </v-col>
